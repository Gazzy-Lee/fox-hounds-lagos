import svgPaths from "./svg-x8bzpldj6w";
import imgImage1 from "./ab1344c85995febe16425e04b930fab042e10196.png";
...
import imgImage13 from "./6c501a2be575018b285c0218299fadb457ffeca3.png";
...
import imgImage19 from "./d508fcb937a546df04c01e96cdc494058eb0b951.png";
...
function HeaderHeroTitle() {
  return (
    <div className="relative shrink-0 w-full" data-name="Header - Hero Title">
      <div className="content-stretch flex flex-col items-start pb-[80px] pt-[100px] px-[60px] relative size-full">
        <Container />
      </div>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Featured Collections Section">
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col gap-[40px] items-start justify-center px-[60px] py-[80px] relative size-full">
          <div className="h-[660px] relative shrink-0 w-full" data-name="image 19">
...
export default function Tablet() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Tablet">
      ...
      <div className="absolute h-[6666px] inset-0 pointer-events-none">
