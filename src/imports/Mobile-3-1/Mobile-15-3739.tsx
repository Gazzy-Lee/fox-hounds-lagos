import svgPaths from "./svg-jsqfzbvobf";
  ...
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Hero Section">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[100px] items-start px-[20px] py-[80px] relative size-full">
          <Container />
          <Container6 />
        </div>
      </div>
...
function Container8() {
  return (
    <div className="content-stretch flex flex-col h-[608px] items-start relative shrink-0 w-[320px]" data-name="Container">
      <Image2 />
...
export default function Mobile() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Mobile">
      ...
      <div className="absolute h-[3918px] inset-0 pointer-events-none">
