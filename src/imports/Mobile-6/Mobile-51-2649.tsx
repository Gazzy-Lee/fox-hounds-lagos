import svgPaths from "./svg-vnxxjjkb9s";
  ...
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Hero Section">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[100px] items-start pb-[60px] pt-[80px] px-[20px] relative size-full">
          <Container />
          <div className="h-[400px] relative shrink-0 w-full" data-name="image 17">
...
function Container14() {
  return (
    <div className="content-stretch flex gap-[24px] h-[162px] items-start relative shrink-0 w-full" data-name="Container">
      <Container15 />
      <Container16 />
    </div>
  );
...
function Container18() {
  return (
    <div className="content-stretch flex gap-[24px] h-[136px] items-start relative shrink-0 w-full" data-name="Container">
      <Container19 />
      <Container20 />
    </div>
  );
...
function Container6() {
  return (
    <div className="content-stretch flex flex-col gap-[60px] items-start relative shrink-0 w-full" data-name="Container">
      <div className="h-[400px] relative shrink-0 w-full" data-name="image 18">
...
export default function Mobile() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Mobile">
      ...
      <div className="absolute h-[3482px] inset-0 pointer-events-none">
