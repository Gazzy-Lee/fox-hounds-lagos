import svgPaths from "./svg-93toano1fc";
import imgImage1 from "./6c501a2be575018b285c0218299fadb457ffeca3.png";
import imgImage2 from "./021cb41c446fc176c3f57015acb4ba813da7998e.png";
import imgImage3 from "./aa1ff2c47917de881d36f4fb2e8e10f7b65c3974.png";
import imgImage5 from "./fff047f7930e9395269bc3b52aff346ddd19baf0.png";
import imgImage6 from "./517f13a4cc04c67c65a9706a04bc532e68ee7d0a.png";
import imgImage7 from "./ff290dffadfa9ba34054b85c9a465900869a30b8.png";
import imgImage8 from "./8eaa3d6d07f78e63cf6502b8561c26e9e24235f3.png";
import imgImage10 from "./5bf1eb0e546c3353e6fdcbb0f491dda989144d0a.png";
import imgImage11 from "./8ca1b166a21462ba4124dccafb0fc6cc79d4e492.png";
import imgImage13 from "./ab1344c85995febe16425e04b930fab042e10196.png";
import imgImage14 from "./1f469486e371fe4fd0a9eee3b114e4d031e57b6f.png";
import imgImage15 from "./443106bd02767912f11614180bf55bbb0c236526.png";
import imgImage9 from "./7f74fadd1eb2d7e420a7d4fa73cb8620f329b5ae.png";
import imgImage4 from "./c84d3d9a9da6b9e8693da5f9c5eb49c3ee21ed48.png";
import imgImage12 from "./ca27b3ec08e7ed8c6228c43166402327ba798caa.png";
import imgImage from "./67adbaa9b67d6f67dec6acdf92226c4b16ec6685.png";
import imgImage16 from "./068516c9fa0e84f6414ae6d696578a863a095a11.png";
import imgImage4X2 from "./65fab89ef39e30fdd07c75ed543a2525d0390284.png";

function Container1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Manrope:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#0282bf] text-[12px] tracking-[2.4px] uppercase whitespace-nowrap">
        <p className="leading-[16px]">Visual Journey</p>
      </div>
    </div>
  );
}
...
function Heading() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 1">
      <div className="flex flex-col font-['Noto_Serif:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#303330] text-[54px] w-full" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
        <p className="leading-[1.2] mb-0">Our Curated</p>
        <p className="leading-[1.2] text-[#0282bf]">Collections</p>
      </div>
    </div>
  );
}
...
function Container() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[16px] items-start max-w-[672px] min-w-px relative" data-name="Container">
      <Container1 />
      <Heading />
    </div>
  );
...
function HeaderHeroTitle() {
  return (
    <div className="relative shrink-0 w-full" data-name="Header - Hero Title">
      <div className="flex flex-row items-end size-full">
        <div className="content-stretch flex items-end justify-between px-[80px] py-[100px] relative size-full">
          <Container />
        </div>
      </div>
    </div>
...
function Image1() {
  return (
    <div className="col-[1/span_8] justify-self-stretch relative row-[1/span_2] self-stretch shrink-0" data-name="image 1">
...
function Image2() {
  return (
    <div className="col-[9/span_4] justify-self-stretch relative rounded-[8px] row-[1/span_2] self-stretch shrink-0" data-name="image 2">
...
function Image3() {
  return (
    <div className="col-[1/span_4] justify-self-stretch relative row-3 self-stretch shrink-0" data-name="image 3">
...
function Image5() {
  return (
    <div className="col-[1/span_8] justify-self-stretch relative row-4 self-stretch shrink-0" data-name="image 5">
...
function Image6() {
  return (
    <div className="col-[9/span_4] justify-self-stretch relative row-4 self-stretch shrink-0" data-name="image 6">
...
function Image7() {
  return (
    <div className="col-[1/span_5] justify-self-stretch relative row-5 self-stretch shrink-0" data-name="image 7">
...
function Image8() {
  return (
    <div className="col-[6/span_7] justify-self-stretch relative row-5 self-stretch shrink-0" data-name="image 8">
...
function Image10() {
  return (
    <div className="col-[1/span_4] justify-self-stretch relative row-[6/span_2] self-stretch shrink-0" data-name="image 10">
...
function Image11() {
  return (
    <div className="col-[9/span_4] justify-self-stretch relative row-[6/span_2] self-stretch shrink-0" data-name="image 11">
...
function Image13() {
  return (
    <div className="col-[1/span_4] justify-self-stretch relative row-[8/span_2] self-stretch shrink-0" data-name="image 13">
...
function Image14() {
  return (
    <div className="col-[5/span_4] justify-self-stretch relative row-[8/span_2] self-stretch shrink-0" data-name="image 14">
...
function Image15() {
  return (
    <div className="col-[9/span_4] justify-self-stretch relative row-[8/span_2] self-stretch shrink-0" data-name="image 15">
...
function Image9() {
  return (
    <div className="col-[5/span_4] justify-self-stretch relative row-[6/span_2] self-stretch shrink-0" data-name="image 9">
...
function Image4() {
  return (
    <div className="col-[5/span_4] justify-self-stretch relative row-3 self-stretch shrink-0" data-name="image 4">
...
function Image12() {
  return (
    <div className="col-[9/span_4] justify-self-stretch relative row-3 self-stretch shrink-0" data-name="image 12">
...
function AsymmetricBentoGridGallery() {
  return (
    <div className="h-[2832px] relative shrink-0 w-full" data-name="Asymmetric Bento Grid Gallery">
      <div className="gap-x-[24px] gap-y-[24px] grid grid-cols-[repeat(12,minmax(0,1fr))] grid-rows-[_________300px_300px_320px_300px_minmax(0,3fr)_minmax(0,2fr)_minmax(0,1fr)_minmax(0,1fr)_minmax(0,1fr)] px-[80px] relative size-full">
        <Image1 />
        <Image2 />
        <Image3 />
        <Image5 />
...
function Image() {
  return (
    <div className="h-[580.25px] relative shrink-0 w-full" data-name="image">
...
function ImageContainer() {
  return (
    <div className="bg-[#f4f4f0] content-stretch flex flex-col items-start justify-center overflow-clip relative rounded-[8px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] shrink-0 w-full" data-name="image container">
      <Image />
    </div>
  );
}
...
function Image16() {
  return (
    <div className="h-[151.59px] relative shrink-0 w-full" data-name="image">
...
function ImageContainer1() {
  return (
    <div className="absolute aspect-video bg-white bottom-[-48px] content-stretch flex flex-col items-start justify-center left-[48.83%] overflow-clip p-[16px] right-[-8.82%] rounded-[4px] shadow-[0px_20px_25px_-5px_rgba(0,0,0,0.1),0px_8px_10px_-6px_rgba(0,0,0,0.1)]" data-name="image container">
      <Image16 />
    </div>
  );
}
...
function Container4() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Manrope:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#0282bf] text-[12px] tracking-[2.4px] uppercase w-full">
        <p className="leading-[16px]">Artisanal Details</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 2">
      <div className="flex flex-col font-['Noto_Serif:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#303330] text-[36px] w-full" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
        <p className="leading-[40px] mb-0">Every Corner Tells a Story of</p>
        <p className="leading-[40px] text-[#0282bf]">Elegance</p>
      </div>
    </div>
  );
}
...
function Container5() {
  return (
    <div className="content-stretch flex flex-col items-start max-w-[512px] pt-[7px] relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#4d4d4d] text-[16px] w-full whitespace-pre-wrap">
        <p className="leading-[1.6] mb-0">{`From the hand-carved mahogany panels in our lounge to the thread count of our Egyptian linens, Fox & Hounds Lagos is a testament to the beauty of detail. `}</p>
        <p className="leading-[1.6] mb-0">​</p>
        <p className="leading-[1.6]">Our gallery captures the ephemeral moments of peace and the vibrant energy of our social spaces.</p>
      </div>
    </div>
  );
}
...
function FeaturedCollectionsSection() {
  return (
    <div className="relative shrink-0 w-full" data-name="Featured Collections Section">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[80px] items-center px-[80px] py-[100px] relative size-full">
          <Container2 />
          <Container3 />
        </div>
      </div>
...
function Main() {
  return (
    <div className="content-stretch flex flex-col items-start max-w-[1440px] relative shrink-0 w-full" data-name="Main">
      <HeaderHeroTitle />
      <AsymmetricBentoGridGallery />
...
function Container38() {
  return (
    <div className="content-stretch flex flex-col h-[32px] items-start justify-center relative shrink-0" data-name="Container">
      <div className="h-[65px] relative shrink-0 w-[147px]" data-name="Image@4x 3">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="Fastline logo" className="absolute h-[115.79%] left-[-3.56%] max-w-none top-[-11.4%] w-[110.99%]" src={imgImage4X2} />
        </div>
      </div>
  ...
  return (
    <div className="max-w-[1920px] relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-row items-center max-w-[inherit] size-full">
        <div className="content-stretch flex items-center justify-between max-w-[inherit] px-[48px] py-[12px] relative size-full">
          <Container38 />
          <Container39 />
          <Button />
        </div>
...
export default function Desktop() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Desktop">
      ...
      <div className="absolute h-[4845.25px] inset-0 pointer-events-none">
