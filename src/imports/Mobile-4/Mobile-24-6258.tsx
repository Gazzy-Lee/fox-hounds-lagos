import svgPaths from "./svg-aywwkx7j7j";
  ...
  return (
    <div className="flex-[1_0_0] h-full min-w-px relative" data-name="Image">
      <video autoPlay className="absolute max-w-none object-cover size-full" controlsList="nodownload" loop playsInline>
        <source src="/_videos/v1/15ef9e78fbe3045a62dca989490dfa867ad1cf57" />
      </video>
    </div>
  );
}
...
function BlueShade() {
  return <div className="bg-[rgba(2,130,191,0.4)] opacity-60 size-full" data-name="blue shade" />;
}
