import svgPaths from "./svg-d7352wtbfo";
  ...
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col gap-[16px] items-start justify-center pb-[40px] pt-[100px] px-[20px] relative size-full">
          <Container1 />
          <Heading />
          <Container2 />
        </div>
...
function Image() {
  return (
    <div className="h-[444px] relative shrink-0 w-full" data-name="image">
...
function RoomsSuites() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-start max-w-[1280px] relative shrink-0 w-full" data-name="Rooms & Suites">
      <Image />
      <BackgroundShadow />
    </div>
  );
...
export default function Mobile() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Mobile">
      <Main />
      <div className="absolute h-[6042px] inset-0 pointer-events-none">
