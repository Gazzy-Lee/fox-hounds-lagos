import svgPaths from "./svg-mqi7f3ibj8";
...
function Heading() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="Heading 1">
      <div className="flex flex-col font-['Noto_Serif:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#303330] text-[0px] whitespace-nowrap" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
        <p className="leading-[1.2] mb-0 text-[54px]">Your escape begins</p>
  ...
  return (
    <div className="bg-white max-w-[1280px] relative shrink-0 w-full" data-name="Header - Hero Branding">
      <div className="flex flex-col items-center max-w-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[8px] items-center max-w-[inherit] px-[60px] py-[100px] relative size-full">
          <Container />
          <Heading />
        </div>
      </div>
...
function ImageContainer() {
  return (
    <div className="bg-[rgba(255,255,255,0)] content-stretch flex flex-col h-[256px] items-start justify-center overflow-clip relative rounded-[8px] shadow-[0px_20px_40px_0px_rgba(48,51,48,0.04)] shrink-0 w-full" data-name="image container">
      <div className="h-[256px] relative shrink-0 w-[680px]" data-name="image">
...
function ContactInfoColumn() {
  return (
    <div className="content-stretch flex flex-col gap-[64px] items-start max-w-[800px] relative shrink-0 w-full" data-name="Contact Info Column">
      <Container1 />
      <ImageContainer />
    </div>
  );
...
function Container25() {
  return (
    <div className="col-[1/span_2] content-stretch flex flex-col gap-[9px] items-start relative row-2 self-start shrink-0 w-[560px]" data-name="Container">
...
function Button() {
  return (
    <div className="bg-[#0282bf] col-[1/span_2] content-stretch flex h-[60px] items-center justify-center justify-self-stretch py-[20px] relative rounded-[4px] row-3 shrink-0" data-name="Button">
...
function Form() {
  return (
    <div className="bg-white drop-shadow-[0px_25px_20px_rgba(0,0,0,0.1)] max-w-[700px] relative rounded-[8px] shrink-0 w-full" data-name="Form">
      <div aria-hidden="true" className="absolute border-[#0282bf] border-solid border-t-4 inset-0 pointer-events-none rounded-[8px]" />
      <div className="content-stretch flex flex-col gap-[32px] items-start max-w-[inherit] p-[60px] relative size-full">
        <Heading1 />
        <Form1 />
      </div>
    </div>
...
function SectionMainContentGrid() {
  return (
    <div className="max-w-[1280px] relative shrink-0 w-full" data-name="Section - Main Content Grid">
      <div className="flex flex-col items-center max-w-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[60px] items-center max-w-[inherit] px-[60px] py-[80px] relative size-full">
          <ContactInfoColumn />
          <Form />
        </div>
      </div>
...
function MapSection() {
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Map Section">
      <div className="content-stretch flex flex-col gap-[24px] items-start px-[60px] py-[80px] relative size-full">
        <Heading2 />
...
function Main() {
  return (
    <div className="content-stretch flex flex-col items-start min-h-[1763px] relative shrink-0 w-full" style={{ backgroundImage: "url('data:image/svg+xml;utf8,<svg viewBox=\\'0 0 800 2301.3\\' xmlns=\\'http://www.w3.org/2000/svg\\' preserveAspectRatio=\\'none\\'><rect x=\\'0\\' y=\\'0\\' height=\\'100%\\' width=\\'100%\\' fill=\\'url(%23grad)\\' opacity=\\'1\\'/><defs><radialGradient id=\\'grad\\' gradientUnits=\\'userSpaceOnUse\\' cx=\\'0\\' cy=\\'0\\' r=\\'10\\' gradientTransform=\\'matrix(113.14 0 0 325.46 0 0)\\'><stop stop-color=\\'rgba(120,90,26,0.03)\\' offset=\\'0\\'/><stop stop-color=\\'rgba(120,90,26,0)\\' offset=\\'0.5\\'/></radialGradient></defs></svg>'), url('data:image/svg+xml;utf8,<svg viewBox=\\'0 0 800 2301.3\\' xmlns=\\'http://www.w3.org/2000/svg\\' preserveAspectRatio=\\'none\\'><rect x=\\'0\\' y=\\'0\\' height=\\'100%\\' width=\\'100%\\' fill=\\'url(%23grad)\\' opacity=\\'1\\'/><defs><radialGradient id=\\'grad\\' gradientUnits=\\'userSpaceOnUse\\' cx=\\'0\\' cy=\\'0\\' r=\\'10\\' gradientTransform=\\'matrix(113.14 0 0 325.46 800 2301.3)\\'><stop stop-color=\\'rgba(120,90,26,0.03)\\' offset=\\'0\\'/><stop stop-color=\\'rgba(120,90,26,0)\\' offset=\\'0.5\\'/></radialGradient></defs></svg>'), linear-gradient(90deg, rgb(250, 249, 246) 0%, rgb(250, 249, 246) 100%)" }} data-name="Main">
      <HeaderHeroBranding />
...
export default function Tablet() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Tablet">
      ...
      <div className="absolute h-[2596.33349609375px] inset-0 pointer-events-none">
