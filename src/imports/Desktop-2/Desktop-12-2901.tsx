import svgPaths from "./svg-lz24hfg8dz";
...
function OverlappingElementForAsymmetry() {
  return (
    <div className="absolute bg-white bottom-[-40px] content-stretch flex flex-col gap-[16.5px] items-start left-[-40px] p-[33px] rounded-[4px] w-[350px]" data-name="Overlapping element for asymmetry">
      ...
      <div className="absolute bg-[rgba(255,255,255,0)] inset-[0_0_0.25px_0] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)]" data-name="Overlapping element for asymmetry:shadow" />
...
function Container7() {
  return (
    <div className="flex-[1_0_0] h-[522px] min-h-[500px] min-w-px relative" data-name="Container">
      <BackgroundShadow />
  ...
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Hero Section">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[80px] items-start px-[80px] py-[100px] relative size-full">
          <Container />
          <Container7 />
        </div>
      </div>
...
function Image1() {
  return (
    <div className="h-[690px] min-w-[325px] relative rounded-[8px] shrink-0 w-[520px]" data-name="image">
...
function Heading1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 2">
      <div className="flex flex-col font-['Noto_Serif:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#303330] text-[0px] w-full" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
        <p className="font-['Noto_Serif:SemiBold',sans-serif] font-semibold leading-[48px] mb-0 text-[#131313] text-[36px]" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
          Local Soul,
        </p>
        <p className="font-['Noto_Serif:SemiBold',sans-serif] font-semibold text-[36px]">
          <span className="leading-[48px] text-[#0282bf]" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>{`Global `}</span>
          <span className="leading-[48px] text-[#131313]" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
            Spirit
          </span>
        </p>
      </div>
...
function Heading3() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 3">
      <div className="flex flex-col font-['Noto_Serif:Display_Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#0282bf] text-[28px] w-full" style={{ fontVariationSettings: "'CTGR' 100, 'wdth' 100" }}>
...
function Dish1() {
  return (
    <div className="bg-white col-2 content-stretch flex flex-col items-start justify-self-stretch overflow-clip relative rounded-[8px] row-1 self-start shrink-0" data-name="Dish 2">
      <Container26 />
      <Container27 />
    </div>
  );
...
function Dish3() {
  return (
    <div className="bg-white col-1 content-stretch flex h-[465px] items-center justify-self-stretch overflow-clip relative rounded-[8px] row-2 shrink-0" data-name="Dish 4">
      <Container30 />
      <Container31 />
    </div>
  );
...
function Container37() {
  return (
    <div className="content-stretch flex flex-col items-start pt-[4px] relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#4d4d4d] text-[16px] w-full">
        <p className="leading-[1.6]">Juicy cuts of beef marinated in house spices, flame-grilled to perfection and served with a savoury glaze.</p>
      </div>
    </div>
  );
}
...
function Dish2() {
  return (
    <div className="bg-white col-2 content-stretch flex flex-col h-[465px] items-start justify-self-stretch overflow-clip relative rounded-[8px] row-2 shrink-0" data-name="Dish 3">
      <Container34 />
      <Container35 />
    </div>
  );
...
function Container21() {
  return (
    <div className="gap-x-[32px] gap-y-[32px] grid grid-cols-[__minmax(0,1.50fr)_minmax(0,1fr)] grid-rows-[repeat(2,fit-content(100%))] relative shrink-0 w-full" data-name="Container">
      <Dish />
      <Dish1 />
      <Dish3 />
      <Dish2 />
...
function Container18() {
  return (
    <div className="content-stretch flex flex-col gap-[80px] items-start max-w-[1600px] relative shrink-0 w-full" data-name="Container">
      <Container19 />
      <Container21 />
    </div>
  );
...
function Container38() {
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex flex-col gap-[8px] items-start px-[80px] relative size-full">
        <Container39 />
        <Heading7 />
        <Caption />
      </div>
...
function Image6() {
  return (
    <div className="h-[614px] relative shrink-0 w-full" data-name="image">
...
function SectionDrinks() {
  return (
    <section className="content-stretch flex flex-col gap-[40px] items-start max-w-[1280px] py-[100px] relative shrink-0 w-full" data-name="Section - Drinks">
      <Container38 />
      <Image6 />
    </section>
  );
...
function Container68() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[24px] h-full items-start min-w-px relative" data-name="Container">
      <Heading8 />
      <Container69 />
      <Container70 />
    </div>
...
function Container95() {
  return (
    <div className="col-[1/span_2] content-stretch flex flex-col gap-[9px] items-start relative row-2 self-start shrink-0 w-[440px]" data-name="Container">
...
function Container91() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[16px] items-start justify-end min-w-px relative" data-name="Container">
      <Heading9 />
      <Form1 />
    </div>
  );
...
function Form() {
  return (
    <div className="bg-white max-w-[1200px] relative rounded-[8px] shrink-0 w-full" data-name="Form">
      ...
      <div className="flex flex-row items-end max-w-[inherit] size-full">
        <div className="content-stretch flex gap-[80px] items-end max-w-[inherit] p-[80px] relative size-full">
...
export default function Desktop() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Desktop">
      <Main />
      <div className="absolute h-[5550px] inset-0 pointer-events-none">
