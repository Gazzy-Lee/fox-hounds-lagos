import svgPaths from "./svg-rh6vqs6lr3";
...
function Image10() {
  return (
    <div className="col-[1/span_6] justify-self-stretch relative row-[6/span_2] self-stretch shrink-0" data-name="image 10">
...
function Image11() {
  return (
    <div className="col-[1/span_12] justify-self-stretch relative row-[8/span_2] self-stretch shrink-0" data-name="image 11">
...
function Image13() {
  return (
    <div className="col-[1/span_12] justify-self-stretch relative row-[10/span_2] self-stretch shrink-0" data-name="image 13">
...
function Image14() {
  return (
    <div className="col-[1/span_12] justify-self-stretch relative row-[12/span_2] self-stretch shrink-0" data-name="image 14">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute h-[217.05%] left-0 max-w-none top-[-8.25%] w-full" src={imgImage14} />
      </div>
    </div>
  );
}
...
function Image15() {
  return (
    <div className="col-[1/span_12] justify-self-stretch relative row-[14/span_2] self-stretch shrink-0" data-name="image 15">
...
function Image9() {
  return (
    <div className="col-[7/span_6] justify-self-stretch relative row-[6/span_2] self-stretch shrink-0" data-name="image 9">
...
function AsymmetricBentoGridGallery() {
  return (
    <div className="h-[4312px] relative shrink-0 w-full" data-name="Asymmetric Bento Grid Gallery">
      <div className="gap-x-[24px] gap-y-[24px] grid grid-cols-[repeat(12,minmax(0,1fr))] grid-rows-[_______________300px_300px_320px_300px_minmax(0,3fr)_minmax(0,2fr)_minmax(0,1fr)_minmax(0,1fr)_minmax(0,1fr)_minmax(0,1fr)_minmax(0,1fr)_minmax(0,1fr)_minmax(0,1fr)_minmax(0,1fr)_minmax(0,1fr)] px-[60px] relative size-full">
        <Image1 />
        <Image2 />
        <Image3 />
        <Image5 />
...
function ImageContainer1() {
  return (
    <div className="absolute aspect-video bg-white bottom-[-34.75px] content-stretch flex flex-col items-start justify-center left-[48.82%] overflow-clip p-[16px] right-[-1.91%] rounded-[4px] shadow-[0px_20px_25px_-5px_rgba(0,0,0,0.1),0px_8px_10px_-6px_rgba(0,0,0,0.1)]" data-name="image container">
      <Image16 />
    </div>
  );
}
...
function Container2() {
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex flex-col items-start pr-[140px] relative size-full">
        <ImageContainer />
        <ImageContainer1 />
      </div>
    </div>
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Featured Collections Section">
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col gap-[80px] items-start justify-center px-[60px] py-[80px] relative size-full">
          <Container2 />
          <Container3 />
        </div>
      </div>
...
export default function Tablet() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Tablet">
      ...
      <div className="absolute h-[6606.25px] inset-0 pointer-events-none">
