import svgPaths from "./svg-quhp6tu2nd";
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Header - Hero Title">
      <div className="flex flex-row items-end size-full">
        <div className="content-stretch flex items-end justify-between pb-[100px] pt-[120px] px-[80px] relative size-full">
          <Container />
        </div>
      </div>
    </div>
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Featured Collections Section">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[40px] items-center px-[80px] py-[100px] relative size-full">
          <div className="h-[660px] relative shrink-0 w-[588px]" data-name="image 19">
...
export default function Desktop() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Desktop">
      ...
      <div className="absolute h-[4945px] inset-0 pointer-events-none">
