import svgPaths from "./svg-j9hvvrg3y5";
import imgImage17 from "./a806de9096560d110407867ee7d0ace8fbb426e0.png";
import imgImage18 from "./6487c952a4a93e8e451d13d9012b2ff5ac9640f9.png";
  ...
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Hero Section">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[100px] items-start pb-[60px] pt-[120px] px-[80px] relative size-full">
          <Container />
          <div className="h-[660.5px] relative shrink-0 w-[562px]" data-name="image 17">
...
function Container6() {
  return (
    <div className="content-center flex flex-wrap gap-[80px] items-center relative shrink-0 w-full" data-name="Container">
      <div className="h-[660px] relative shrink-0 w-[572px]" data-name="image 18">
...
export default function Desktop() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Desktop">
      ...
      <div className="absolute h-[2571.5px] inset-0 pointer-events-none">
