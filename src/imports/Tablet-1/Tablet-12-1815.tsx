import svgPaths from "./svg-vfataako7o";
...
function Container3() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-[680px]" data-name="Container">
      <Container4 />
    </div>
  );
}
...
function Margin() {
  return (
    <div className="h-[344px] relative shrink-0 w-full" data-name="Margin">
      <div className="flex flex-col items-center justify-end size-full">
        <div className="content-stretch flex flex-col items-center justify-end px-[20px] relative size-full">
          <BackgroundShadow />
        </div>
      </div>
    </div>
...
function RoomsSuites() {
  return (
    <div className="content-stretch flex flex-col h-[838px] items-center justify-between max-w-[1280px] relative shrink-0 w-full" data-name="Rooms & Suites">
      <Container3 />
      <Margin />
    </div>
  );
...
export default function Tablet() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Tablet">
      <Main />
      <div className="absolute h-[4637.97998046875px] inset-0 pointer-events-none">
