import svgPaths from "./svg-pxbfkbj42y";
...
function Container2() {
  return (
    <div className="content-stretch flex flex-col items-start pt-[7.25px] relative shrink-0 w-full" data-name="Container">
...
function Image() {
  return (
    <div className="flex-[1_0_0] h-full min-w-px relative rounded-[12px]" data-name="Image">
      <video autoPlay className="absolute max-w-none object-cover rounded-[12px] size-full" controlsList="nodownload" loop playsInline>
...
function HeroSectionArenaOfExcellence() {
  return (
    <div className="bg-white content-stretch flex gap-[40px] h-[541.25px] items-center overflow-clip px-[60px] py-[80px] relative shrink-0 w-[800px]" data-name="Hero Section: Arena of Excellence">
      <Container />
      <ImageContainer />
    </div>
  );
...
function MatchScheduleSection() {
  return (
    <div className="bg-[#f6f6f3] content-stretch flex flex-col h-[772px] items-start px-[60px] py-[80px] relative shrink-0 w-[800px]" data-name="Match Schedule Section">
      <Container3 />
    </div>
  );
}
...
function BlueShade() {
  return <div className="absolute bg-[rgba(2,130,191,0.4)] inset-[381px_-40px_-41px_49px] opacity-60" data-name="blue shade" />;
}
...
function Container6() {
  return (
    <div className="content-stretch flex gap-[60px] items-center max-w-[1400px] relative shrink-0 w-full" data-name="Container">
      <Container7 />
      <Container8 />
    </div>
  );
...
function PrivateLegacySection() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start overflow-clip px-[60px] py-[80px] relative shrink-0 w-[800px]" data-name="Private Legacy Section">
      <Container6 />
    </div>
  );
}
  ...
  return (
    <div className="bg-white max-w-[896px] relative rounded-[8px] shrink-0 w-full" data-name="Form">
      <div className="flex flex-col items-center justify-center max-w-[inherit] overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[64px] items-center justify-center max-w-[inherit] p-[60px] relative size-full">
          <Container20 />
          <Form1 />
        </div>
      </div>
...
function InquiryFormSection() {
  return (
    <div className="bg-[#f6f6f3] content-stretch flex flex-col items-center justify-center px-[80px] py-[100px] relative shrink-0 w-[800px]" data-name="Inquiry Form Section">
      <Form />
    </div>
  );
}
...
function Trigger() {
  return <div className="-translate-x-1/2 absolute h-[75px] left-[calc(50%-202px)] top-[1424px] w-[236px]" data-name="trigger" />;
}
...
export default function Tablet() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Tablet">
      ...
      <div className="absolute h-[3792.25px] inset-0 pointer-events-none">
