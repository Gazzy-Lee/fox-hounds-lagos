import svgPaths from "./svg-qqu3qm122k";
...
import imgImage4 from "./ca27b3ec08e7ed8c6228c43166402327ba798caa.png";
import imgImage12 from "./c84d3d9a9da6b9e8693da5f9c5eb49c3ee21ed48.png";
...
function Heading() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 1">
      <div className="flex flex-col font-['Noto_Serif:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#303330] text-[0px] w-full" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
        <p className="leading-[1.2] mb-0 text-[40px]">Our Curated</p>
        <p className="leading-[1.2] text-[#0282bf] text-[40px]">Collections</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Header - Hero Title">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between pb-[80px] pt-[100px] px-[20px] relative size-full">
          <Container />
        </div>
      </div>
    </div>
...
function Image() {
  return (
    <div className="col-[1/span_2] justify-self-stretch relative row-[1/span_2] self-stretch shrink-0" data-name="image 1">
...
function Image1() {
  return (
    <div className="col-[1/span_2] justify-self-stretch relative rounded-[8px] row-[3/span_2] self-stretch shrink-0" data-name="image 2">
...
function Image2() {
  return (
    <div className="col-[1/span_2] h-[324px] justify-self-start relative row-5 self-start shrink-0 w-[335px]" data-name="image 3">
...
function Image3() {
  return (
    <div className="col-[1/span_2] relative row-[9/span_2] self-stretch shrink-0 w-[335px]" data-name="image 4">
...
function Image11() {
  return (
    <div className="col-[1/span_2] relative row-[7/span_2] self-stretch shrink-0 w-[335px]" data-name="image 12">
...
function Image4() {
  return (
    <div className="col-[1/span_2] h-[166.222px] justify-self-stretch relative row-11 shrink-0" data-name="image 5">
...
function Image5() {
  return (
    <div className="col-[1/span_2] justify-self-stretch relative row-12 self-stretch shrink-0" data-name="image 6">
...
function Image6() {
  return (
    <div className="col-[1/span_2] relative row-[13/span_2] self-stretch shrink-0 w-[335px]" data-name="image 7">
...
function Image7() {
  return (
    <div className="col-[1/span_2] relative row-15 self-stretch shrink-0 w-[335px]" data-name="image 8">
...
function Image8() {
  return (
    <div className="col-[1/span_2] h-[198px] relative row-[18/span_3] shrink-0 w-[335px]" data-name="image 9">
...
function Image9() {
  return (
    <div className="col-[1/span_2] relative row-[16/span_2] self-stretch shrink-0 w-[335px]" data-name="image 10">
...
function Image10() {
  return (
    <div className="col-[1/span_2] h-[150px] relative row-21 shrink-0 w-[335px]" data-name="image 11">
...
function Image12() {
  return (
    <div className="col-[1/span_2] h-[150px] relative row-22 shrink-0 w-[335px]" data-name="image 13">
...
function Image13() {
  return (
    <div className="col-[1/span_2] h-[150px] relative row-23 shrink-0 w-[335px]" data-name="image 14">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute h-[297.78%] left-0 max-w-none top-[-12.22%] w-full" src={imgImage14} />
      </div>
    </div>
  );
}
...
function Image14() {
  return (
    <div className="col-[1/span_2] h-[150px] relative row-24 shrink-0 w-[335px]" data-name="image 15">
...
function AsymmetricBentoGridGallery() {
  return (
    <div className="relative shrink-0 w-full" data-name="Asymmetric Bento Grid Gallery">
      <div className="gap-x-[24px] gap-y-[24px] grid grid-cols-[repeat(2,minmax(0,1fr))] grid-rows-[________________________150px_150px_150px_150px_150px_150px_150px_150px_150px_150px_150px_150px_150px_150px_150px_150px_150px_150px_fit-content(100%)_fit-content(100%)_fit-content(100%)_fit-content(100%)_fit-content(100%)_fit-content(100%)] px-[20px] relative size-full">
        <Image />
        <Image1 />
        <Image2 />
        <Image3 />
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Featured Collections Section">
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col gap-[40px] items-start justify-center px-[20px] py-[80px] relative size-full">
...
export default function Mobile() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Mobile">
      ...
      <div className="absolute h-[6302px] inset-0 pointer-events-none">
