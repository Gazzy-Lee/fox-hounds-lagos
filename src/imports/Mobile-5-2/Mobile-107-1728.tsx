import svgPaths from "./svg-3pt9cbh66x";
  ...
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Hero Section">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[60px] items-start pb-[80px] pt-[100px] px-[20px] relative size-full">
          <Container />
          <Container7 />
        </div>
      </div>
...
export default function Mobile() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Mobile">
      <Main />
      <div className="absolute h-[7546px] inset-0 pointer-events-none">
