import svgPaths from "./svg-0lxzuzol8g";
  ...
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col gap-[16px] items-start justify-center pb-[40px] pt-[120px] px-[80px] relative size-full">
          <Container1 />
          <Heading />
          <Container2 />
        </div>
...
function Image() {
  return (
    <div className="h-[881px] mr-[-140px] relative shrink-0 w-[652px]" data-name="image">
...
function BackgroundShadow() {
  return (
    <div className="bg-white content-stretch drop-shadow-[0px_20px_20px_rgba(0,0,0,0.4)] flex flex-col gap-[12px] items-start mr-[-140px] p-[64px] relative rounded-[8px] shrink-0 w-[595px]" data-name="Background+Shadow">
      <Container3 />
      <Heading1 />
      <Container4 />
      <List />
...
function RoomsSuites() {
  return (
    <div className="content-stretch flex items-center max-w-[1280px] pr-[140px] relative shrink-0 w-full" data-name="Rooms & Suites">
      <Image />
      <BackgroundShadow />
    </div>
  );
...
export default function Desktop() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Desktop">
      <Main />
      <div className="absolute h-[4544.97998046875px] inset-0 pointer-events-none">
