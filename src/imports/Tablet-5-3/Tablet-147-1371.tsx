import svgPaths from "./svg-ncbx7dz1eq";
...
function Image() {
  return (
    <div className="flex-[1_0_0] h-full min-w-px relative rounded-[12px]" data-name="Image">
      <video autoPlay className="absolute max-w-none object-cover rounded-[12px] size-full" controls controlsList="nodownload" loop playsInline>
