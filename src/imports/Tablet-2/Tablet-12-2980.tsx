import svgPaths from "./svg-shlne5uxxw";
  ...
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Hero Section">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[80px] items-start px-[60px] py-[80px] relative size-full">
          <Container />
          <Container7 />
        </div>
      </div>
...
export default function Tablet() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Tablet">
      <Main />
      <div className="absolute h-[6991px] inset-0 pointer-events-none">
