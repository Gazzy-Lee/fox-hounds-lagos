import svgPaths from "./svg-i01o1bq8e3";
  ...
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col gap-[16px] items-start justify-center pb-[40px] pt-[80px] px-[20px] relative size-full">
          <Container1 />
          <Heading />
          <Container2 />
        </div>
...
function Heading1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 2">
      <div className="flex flex-col font-['Noto_Serif:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#0282bf] text-[28px] whitespace-nowrap" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
...
function BackgroundShadow() {
  return (
    <div className="bg-white relative rounded-[8px] shadow-[0px_20px_40px_0px_rgba(0,0,0,0.4)] shrink-0 w-full" data-name="Background+Shadow">
      <div className="content-stretch flex flex-col gap-[12px] items-start px-[32px] py-[40px] relative size-full">
        <Container5 />
        <Heading1 />
        <Container6 />
        <List />
...
function Margin() {
  return (
    <div className="h-[511px] relative shrink-0 w-full" data-name="Margin">
      <div className="flex flex-col items-center justify-end size-full">
        <div className="content-stretch flex flex-col items-center justify-end px-[8px] relative size-full">
          <BackgroundShadow />
        </div>
      </div>
    </div>
...
function RoomsSuites() {
  return (
    <div className="content-stretch flex flex-col items-start max-w-[1280px] relative shrink-0 w-full" data-name="Rooms & Suites">
      <Container3 />
      <Margin />
    </div>
  );
...
function Image1() {
  return (
    <div className="h-[300px] min-w-[260px] relative shrink-0 w-full" data-name="image">
...
function ImageContainer() {
  return (
    <div className="content-stretch flex flex-col items-start min-w-[260px] overflow-clip relative shrink-0 w-full z-[2]" data-name="image container">
      <Image1 />
    </div>
  );
}
...
function Container13() {
  return (
    <div className="min-w-[260px] relative shrink-0 w-full z-[1]" data-name="Container">
      <div className="content-stretch flex flex-col gap-[16px] items-start min-w-[inherit] p-[32px] relative size-full">
...
function StudioApartment() {
  return (
    <div className="bg-white content-stretch flex flex-col isolate items-start relative rounded-bl-[8px] rounded-tl-[8px] rounded-tr-[8px] shrink-0 w-full" data-name="Studio apartment">
      <ImageContainer />
      <Container13 />
    </div>
  );
...
function ImageContainer1() {
  return (
    <div className="content-stretch flex flex-col items-start min-w-[260px] overflow-clip relative shrink-0 w-full" data-name="image container">
      <Image2 />
    </div>
  );
}
...
function Container19() {
  return (
    <div className="min-w-[260px] relative shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex flex-col gap-[16px] items-start min-w-[inherit] p-[32px] relative size-full">
        <div className="flex flex-col font-['Noto_Serif:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#0282bf] text-[24px] whitespace-nowrap" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
...
function RoomMiniFlat() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start justify-center relative rounded-[8px] shrink-0 w-full" data-name="Room mini flat">
      <ImageContainer1 />
      <Container19 />
    </div>
  );
...
function ImageContainer2() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-full" data-name="image container">
      <Image3 />
    </div>
  );
}
...
function Bungalow() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start justify-center relative rounded-[8px] shrink-0 w-full" data-name="Bungalow">
      <ImageContainer2 />
      <Container25 />
    </div>
  );
  ...
  return (
    <div className="bg-[#f6f6f3] relative shrink-0 w-full" data-name="Room Sections - Asymmetric Layout">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[100px] items-start px-[20px] py-[60px] relative size-full">
          <RoomsSuites />
          <ShortLets />
        </div>
      </div>
...
function Container34() {
  return (
    <div className="content-start flex flex-wrap gap-[32px_48px] items-start justify-center relative shrink-0 w-full" data-name="Container">
      <Container35 />
      <Container39 />
      <Container43 />
      <Frame />
...
function Container31() {
  return (
    <div className="max-w-[1280px] relative shrink-0 w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[40px] items-center max-w-[inherit] relative size-full">
        <Container32 />
        <Container34 />
      </div>
    </div>
...
function SectionSignatureAmenitiesGrid() {
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Section - Signature Amenities Grid">
      ...
      <div className="content-stretch flex flex-col items-start px-[20px] py-[81px] relative size-full">
        <Container31 />
      </div>
    </div>
  );
...
export default function Mobile() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Mobile">
      <Main />
      <div className="absolute h-[5857.97998046875px] inset-0 pointer-events-none">
