import svgPaths from "./svg-xr89s9njc2";
  ...
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Hero Section">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[100px] items-start pb-[60px] pt-[80px] px-[60px] relative size-full">
          <Container />
          <div className="h-[600px] relative shrink-0 w-full" data-name="image 17">
...
function Container6() {
  return (
    <div className="content-stretch flex flex-col gap-[80px] h-[1204px] items-start justify-center relative shrink-0 w-full" data-name="Container">
      <div className="h-[660px] relative shrink-0 w-full" data-name="image 18">
...
export default function Tablet() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Tablet">
      ...
      <div className="absolute h-[3664px] inset-0 pointer-events-none">
