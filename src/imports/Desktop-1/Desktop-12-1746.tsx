import svgPaths from "./svg-7vti9kfks4";
import imgImage from "./d6562a8af50c5936fb6fd3108c673d664db17b69.png";
import imgImage1 from "./95276733c448fda2dac6f817fbda6a5e0346df44.png";
import imgImage2 from "./8ce983b978b364f1764629b54f76cb90c90509ad.png";
import imgImage3 from "./1a32ac58325a375fd97833428075853baca5385e.png";
...
function Container1() {
  return (
    <div className="content-stretch flex flex-col h-[15px] items-start relative shrink-0 w-[174px]" data-name="Container">
      <div className="flex flex-col font-['Manrope:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#0282bf] text-[10px] tracking-[3px] uppercase whitespace-nowrap">
...
function Heading() {
  return (
    <div className="content-stretch flex flex-col items-start max-w-[650px] relative shrink-0 w-full" data-name="Heading 1">
  ...
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col gap-[16px] items-start justify-center pb-[60px] pt-[100px] px-[80px] relative size-full">
          <Container1 />
          <Heading />
          <Container2 />
        </div>
...
function Image() {
  return (
    <div className="h-[443.98px] relative shrink-0 w-full" data-name="image">
...
function Container3() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-[710.39px]" data-name="Container">
      <Container4 />
    </div>
  );
}
...
function BackgroundShadow() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[12px] items-start p-[64px] relative rounded-[8px] shadow-[0px_20px_40px_0px_rgba(0,0,0,0.4)] shrink-0 w-[470px]" data-name="Background+Shadow">
      <Container5 />
      <Heading1 />
      <Container6 />
      <List />
...
function Margin() {
  return (
    <div className="content-stretch flex flex-col items-end relative shrink-0 w-[378px]" data-name="Margin">
      <BackgroundShadow />
    </div>
  );
}
...
function RoomsSuites() {
  return (
    <div className="content-stretch flex items-center justify-between max-w-[1280px] relative shrink-0 w-full" data-name="Rooms & Suites">
      <Container3 />
      <Margin />
    </div>
  );
...
function Group1() {
  return (
    <div className="h-[18px] relative shrink-0 w-[17.64px]" data-name="Group">
...
function Image1() {
  return (
    <div className="h-[380px] relative shrink-0 w-full" data-name="image">
...
function ImageContainer() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-[260px] overflow-clip relative z-[1]" data-name="image container">
      <Image1 />
    </div>
  );
}
...
function StudioApartment() {
  return (
    <div className="bg-white content-stretch flex h-[380.98px] isolate items-start relative rounded-bl-[8px] rounded-tl-[8px] rounded-tr-[8px] shrink-0 w-[1120px]" data-name="Studio apartment">
      <Container13 />
      <ImageContainer />
    </div>
  );
...
function ImageContainer1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-[260px] overflow-clip relative" data-name="image container">
      <Image2 />
    </div>
  );
}
...
function Container19() {
  return (
    <div className="flex-[1_0_0] h-[380px] min-w-[260px] relative" data-name="Container">
      <div className="content-stretch flex flex-col gap-[16px] items-start min-w-[inherit] px-[32px] py-[40px] relative size-full">
        <div className="flex flex-col font-['Noto_Serif:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#0282bf] text-[24px] whitespace-nowrap" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
...
function RoomMiniFlat() {
  return (
    <div className="bg-white content-stretch flex items-center relative rounded-[8px] shrink-0 w-full" data-name="Room mini flat">
      <ImageContainer1 />
      <Container19 />
    </div>
  );
...
function Container26() {
  return (
    <div className="content-stretch flex flex-col items-start max-w-[450px] pb-[120px] relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#4d4d4d] text-[16px] w-full">
        <p className="leading-[1.6]">{`These are spacious & fully equipped units, perfect for families or small groups looking for a relaxed and private stay.`}</p>
      </div>
    </div>
  );
}
...
function ImageContainer2() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-[560px]" data-name="image container">
      <Image3 />
    </div>
  );
}
...
function Bungalow() {
  return (
    <div className="bg-white content-stretch flex items-center relative rounded-[8px] shrink-0 w-full" data-name="Bungalow">
      <Container25 />
      <ImageContainer2 />
    </div>
  );
  ...
  return (
    <div className="bg-[#f6f6f3] relative shrink-0 w-full" data-name="Room Sections - Asymmetric Layout">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[160px] items-start px-[80px] py-[100px] relative size-full">
          <RoomsSuites />
          <ShortLets />
        </div>
      </div>
...
function SectionSignatureAmenitiesGrid() {
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Section - Signature Amenities Grid">
      ...
      <div className="content-stretch flex flex-col items-start px-[80px] py-[101px] relative size-full">
        <Container31 />
      </div>
    </div>
  );
...
function Main() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[1280px]" data-name="Main">
      <Container />
...
export default function Desktop() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Desktop">
      <Main />
      <div className="absolute h-[4276.97998046875px] inset-0 pointer-events-none">
