import svgPaths from "./svg-x5j7r603j6";
...
function Image() {
  return (
    <div className="flex-[1_0_0] h-full min-w-px relative" data-name="Image">
      <video autoPlay className="absolute max-w-none object-cover size-full" controls controlsList="nodownload" loop playsInline>
...
function ImageContainer() {
  return (
    <div className="content-stretch flex h-[190.75px] items-center overflow-clip relative rounded-[12px] shrink-0 w-full" data-name="image container">
      <Image />
    </div>
  );
}
...
function HeroSectionArenaOfExcellence() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[40px] items-center overflow-clip px-[20px] py-[80px] relative shrink-0 w-[375px]" data-name="Hero Section: Arena of Excellence">
      <Container />
      <ImageContainer />
    </div>
  );
...
function Container3() {
  return (
    <section className="content-stretch flex flex-col gap-[40px] items-start max-w-[1400px] shrink-0 sticky top-0 w-full" data-name="container">
      <Container4 />
      <Carousel />
    </section>
  );
...
function MatchScheduleSection() {
  return (
    <div className="bg-[#f6f6f3] content-stretch flex flex-col h-[788px] items-start px-[20px] py-[60px] relative shrink-0 w-[375px]" data-name="Match Schedule Section">
      <Container3 />
    </div>
  );
}
...
function BlueShade() {
  return <div className="bg-[rgba(2,130,191,0.4)] opacity-60 relative size-full" data-name="blue shade" />;
}

function Image4() {
  return (
    <div className="h-[447px] relative shrink-0 w-full" data-name="image">
...
function Container7() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-full" data-name="Container">
      <div className="absolute flex inset-[239.34px_-151.22px_-46px_113.88px] items-center justify-center" style={{ containerType: "size" }}>
...
function Heading5() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 4">
      <div className="flex flex-col font-['Manrope:Bold',sans-serif] font-bold h-[20px] justify-center leading-[0] relative shrink-0 text-[#303330] text-[18px] w-full">
        <p className="leading-[20px]">Event Decor</p>
      </div>
    </div>
  );
}
...
function Container6() {
  return (
    <div className="content-stretch flex flex-col gap-[100px] items-start justify-center max-w-[1400px] relative shrink-0 w-full" data-name="Container">
      <Container7 />
      <Container8 />
    </div>
  );
...
function PrivateLegacySection() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start overflow-clip px-[20px] py-[60px] relative shrink-0 w-[375px]" data-name="Private Legacy Section">
      <Container6 />
    </div>
  );
}
...
function Container25() {
  return (
    <div className="col-1 content-stretch flex flex-col gap-[9px] items-start justify-self-stretch relative row-3 self-start shrink-0" data-name="Container">
...
function Form1() {
  return (
    <div className="gap-x-[32px] gap-y-[20px] grid grid-cols-[repeat(1,minmax(0,1fr))] grid-rows-[repeat(4,fit-content(100%))] relative shrink-0 w-full" data-name="Form">
      ...
      <Container24 />
      <Container25 />
      <div className="backdrop-blur-[6px] bg-[#0282bf] col-1 justify-self-stretch relative rounded-[4px] row-4 self-stretch shrink-0" data-name="Primary Button">
  ...
  return (
    <div className="bg-white max-w-[896px] relative rounded-[8px] shrink-0 w-full" data-name="Form">
      <div className="flex flex-col items-center justify-center max-w-[inherit] overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[64px] items-center justify-center max-w-[inherit] px-[20px] py-[40px] relative size-full">
          <Container20 />
          <Form1 />
        </div>
      </div>
...
function InquiryFormSection() {
  return (
    <div className="bg-[#f6f6f3] content-stretch flex flex-col items-center justify-center px-[20px] py-[60px] relative shrink-0 w-[375px]" data-name="Inquiry Form Section">
      <Form />
    </div>
  );
}
...
function Trigger() {
  return <div className="-translate-x-1/2 absolute h-[75px] left-[calc(50%+10.5px)] top-[1424px] w-[236px]" data-name="trigger" />;
}
...
export default function Mobile() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Mobile">
      ...
      <div className="absolute h-[4535.02490234375px] inset-0 pointer-events-none">
