import svgPaths from "./svg-64yme7pupo";
    ...
    <div className="relative shrink-0" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start justify-center py-[0.5px] relative size-full">
        <div className="flex flex-col font-['Manrope:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[14px] text-center text-white tracking-[1.2px] uppercase whitespace-nowrap">
          <p className="leading-[16px]">Reserve a table</p>
        </div>
      </div>
    </div>
  );
...
function Container6() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-[608px] items-start min-w-px relative" data-name="Container">
      <Image />
  ...
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Hero Section">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[100px] items-start px-[80px] py-[100px] relative size-full">
          <Container />
          <Container6 />
        </div>
      </div>
...
function Container16() {
  return (
    <div className="content-stretch flex gap-[24px] h-[110px] items-start relative shrink-0 w-full" data-name="Container">
      <Container17 />
      <Container18 />
    </div>
  );
...
function Container7() {
  return (
    <div className="content-center flex flex-wrap gap-[80px] items-center relative shrink-0 w-full" data-name="Container">
      <Container8 />
      <Container9 />
    </div>
  );
...
export default function Desktop() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Desktop">
      ...
      <div className="absolute h-[2494px] inset-0 pointer-events-none">
