import svgPaths from "./svg-ipmo0nviwq";
...
function OverlappingElementForAsymmetry() {
  return (
    <div className="absolute bg-white bottom-[-40px] content-stretch flex flex-col gap-[16.5px] items-start left-[23px] p-[33px] right-[33px] rounded-[4px]" data-name="Overlapping element for asymmetry">
      ...
      <div className="flex flex-col font-['Noto_Serif:Display_ExtraBold',sans-serif] font-extrabold justify-center leading-[0] min-w-full relative shrink-0 text-[#303330] text-[18px] w-[min-content]" style={{ fontVariationSettings: "'CTGR' 100, 'wdth' 100" }}>
        <p className="leading-[29.25px]">{`"The finest expression of Nigerian ingredients I've ever experienced."`}</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Hero Section">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[60px] items-start px-[20px] py-[80px] relative size-full">
          <Container />
          <Container7 />
        </div>
      </div>
...
function Image1() {
  return (
    <div className="flex-[1_0_0] h-[400px] min-w-[325px] relative rounded-[8px]" data-name="image">
...
function ImageContainer() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="image container">
      <Image1 />
    </div>
  );
}
...
function Container9() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-start min-w-[325px] relative shrink-0 w-full" data-name="Container">
      <Heading1 />
      <Container10 />
      <HorizontalBorder />
    </div>
...
function Container8() {
  return (
    <div className="content-stretch flex flex-col gap-[60px] items-start justify-center relative shrink-0 w-full" data-name="Container">
      <ImageContainer />
      <Container9 />
    </div>
  );
...
function Image2() {
  return (
    <div className="h-[245px] relative shrink-0 w-full" data-name="image">
...
function Heading3() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 3">
      <div className="flex flex-col font-['Noto_Serif:Display_Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#0282bf] text-[20px] w-full" style={{ fontVariationSettings: "'CTGR' 100, 'wdth' 100" }}>
...
function Dish() {
  return (
    <div className="bg-white col-1 content-stretch flex flex-col items-start justify-center justify-self-stretch overflow-clip relative rounded-[8px] row-1 self-start shrink-0" data-name="Dish 1">
      <Container22 />
      <Container23 />
    </div>
  );
...
function Dish1() {
  return (
    <div className="bg-white col-1 content-stretch flex flex-col h-[490px] items-start justify-self-stretch overflow-clip relative rounded-[8px] row-2 shrink-0" data-name="Dish 2">
      <Container26 />
      <Container27 />
    </div>
  );
...
function Container30() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-center min-h-px overflow-clip relative w-full" data-name="Container">
      <Image4 />
    </div>
  );
}
...
function Dish3() {
  return (
    <div className="bg-white col-1 content-stretch flex flex-col h-[490px] items-start justify-center justify-self-stretch overflow-clip relative rounded-[8px] row-3 shrink-0" data-name="Dish 4">
      <Container30 />
      <Container31 />
    </div>
  );
...
function Dish2() {
  return (
    <div className="bg-white col-1 content-stretch flex flex-col h-[490px] items-start justify-self-stretch overflow-clip relative rounded-[8px] row-4 shrink-0" data-name="Dish 3">
      <Container34 />
      <Container35 />
    </div>
  );
...
function Container38() {
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex flex-col gap-[8px] items-start px-[20px] relative size-full">
        <Container39 />
        <Heading7 />
        <Caption />
      </div>
...
function Image6() {
  return (
    <div className="h-[210px] relative shrink-0 w-full" data-name="image">
...
function SectionDrinks() {
  return (
    <section className="content-stretch flex flex-col gap-[40px] items-start max-w-[1280px] py-[60px] relative shrink-0 w-full" data-name="Section - Drinks">
      <Container38 />
      <Image6 />
    </section>
  );
...
function Form1() {
  return (
    <div className="gap-x-[32px] gap-y-[20px] grid grid-cols-[repeat(1,minmax(0,1fr))] grid-rows-[____fit-content(100%)_fit-content(100%)_fit-content(100%)_49.00px] relative shrink-0 w-full" data-name="Form">
      <Container92 />
      <Container94 />
      <Container95 />
  ...
  return (
    <div className="bg-white max-w-[1200px] relative rounded-[8px] shrink-0 w-full" data-name="Form">
      ...
      <div className="flex flex-col justify-end max-w-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[80px] items-start justify-end max-w-[inherit] p-[32px] relative size-full">
          <Container68 />
          <Container91 />
        </div>
      </div>
...
export default function Mobile() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Mobile">
      <Main />
      <div className="absolute h-[7526px] inset-0 pointer-events-none">
